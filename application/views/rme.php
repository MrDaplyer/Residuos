<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Lotes de RME Pendientes de Salida <span class="badge badge-primary">RME</span></h1>
        <div class="btn-group" role="group" aria-label="acciones-lote-personalizado">
            <button id="btn-finalizar-lote-personalizado" class="btn btn-outline-primary mr-2" disabled>
                <i class="fas fa-check-double"></i> Finalizar lote personalizado
                <span class="badge badge-pill badge-primary ml-2" id="badge-seleccionados">0</span>
            </button>
            <button id="btn-limpiar-seleccion" class="btn btn-light mr-3" style="display:none;">
                <i class="fas fa-eraser"></i>
            </button>
            <button id="btn-lote-personalizado-rme" class="btn btn-primary btn-icon-split">
  ...
  border-width: 2px !important;
    ...
    <div class="row">
        <?php foreach ($fechas_pendientes as $fecha_data): ?>
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-100 py-2 lote-card" data-fecha="<?= $fecha_data['fecha_ingreso_unica']; ?>" style="cursor: pointer;">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                         ...
                         <button class="btn btn-primary btn-icon-split btn-sm mt-3 btn-completar-lote" data-fecha="<?= $fecha_data['fecha_ingreso_unica']; ?>" onclick="event.stopPropagation();">
                            <span class="icon text-white-50">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="table-responsive p-3">
            <table class="table align-items-center table-flush table-responsive-text" id="dataTableRME" width="100%">
                <thead class="thead-light">
                    <tr>
                        <th><input type="checkbox" id="selectAll-rme"></th>
                        <th>ID</th>
                        <th>Trabajador</th>
                        <th>Residuo</th>
                        <th>Clave</th>
...
<script>
    var rme_ajax_url = "<?= base_url('rme/get_rme_data_ajax') ?>";
    var base_url = "<?= base_url() ?>";
    var rme_rango_ajax_url = "<?= base_url('rme/get_registros_por_rango_ajax') ?>";
</script>

<!-- Modal selector de residuos por lote (RME) -->
<div class="modal fade" id="selectorResiduoModal" tabindex="-1" role="dialog" aria-labelledby="selectorResiduoLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="selectorResiduoLabel">Selecciona los residuos de este lote</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div id="lista-residuos-lote" class="list-group">
          <!-- items dinámicos -->
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" id="btn-agregar-al-buffer">Agregar al lote personalizado</button>
      </div>
    </div>
  </div>
 </div>
...
<div class="modal fade" id="loteModal" tabindex="-1" role="dialog" aria-labelledby="loteModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="loteModalLabel">Completar Lote de RME</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <!-- Vista 1: Formulario -->
      <div id="view-form">
          <form id="loteForm" action="<?= base_url('rme/procesar_lote'); ?>" method="POST">
            <div class="modal-body">
      ...
      <div id="view-table" style="display: none;">
          <div class="modal-body">
              ...
              <div class="table-responsive">
                <table class="table table-sm" id="editableTableRME">
                    <thead>
                        <tr>
